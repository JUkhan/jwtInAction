...
export default function config(stateprovider, routeProvider){
	...
	stateprovider.state('root.login',{url:'/login',templateUrl:'template/login',controller:'loginCtrl as vm'});
	stateprovider.state('root.signup',{url:'/signup',templateUrl:'template/signup',controller:'signupCtrl as vm'});
